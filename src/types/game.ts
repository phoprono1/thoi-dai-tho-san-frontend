...
export const PET_EQUIPMENT_SLOTS = {
  PET_COLLAR: { name: 'Vòng cổ Pet', icon: '🎀', slot: 'collar', order: 1 },
  PET_ARMOR: { name: 'Áo giáp Pet', icon: '🛡️', slot: 'armor', order: 2 },
  PET_ACCESSORY: { name: 'Phụ kiện Pet', icon: '💍', slot: 'accessory', order: 3 },
  PET_WEAPON: { name: 'Vũ khí Pet', icon: '⚔️', slot: 'weapon', order: 4 },
} as const;
